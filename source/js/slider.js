...
function scrollIt(x){
    ...
    document.querySelector('.example__image-block--after').style.width = transform+"px";
    document.querySelector('.example__image-block--before').style.width = widthBefore+"px";
